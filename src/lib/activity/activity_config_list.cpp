...
init_activity_config_list(){
    ...
    ACTIVITY_CONFIG_GOD = ActivityConfig(
        ...
        "God",
        {
            ...
            ParamConfig("MPC_Z_VEL_MAX_U",    INTERVAL,     DOG,    1,    6,   0.5f,  {}                 ),
            ParamConfig("MPC_Z_VEL_MAX_D",    INTERVAL,     DOG,    1,    6,   0.5f,  {}                 ),
       });
    ...
    ACTIVITY_CONFIG_LIST[1] = ActivityConfig(
            ...
            activityNames[ACTIVITY_SURF],
            {
                ...
                ParamConfig("A_SAH_NO_SPOT",      VALUES_STR,    DOG,      -1,    -1,  -1,    {1}              ),
    ...
    {0,0,0,0,5,10,12,1,0,20,0,1,1.2,0,2,6,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {1,3,1,0,5,7,12,1,1,20,0,1,1.5,0,2,5,5,150,20,0,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {2,1,0,4,5,10,12,2,0,35,1,1,1.5,0,2,7,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {3,0,0,0,5,10,12,1,0,20,0,1,1,0,2,3,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {4,1,0,4,5,10,10,2,0,30,1,1,1.5,0,2,6,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {5,3,1,0,5,10,12,1,1,20,0,1,1.5,0,2,5,5,150,20,0,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {6,1,1,4,5,12,12,1,1,35,1,1,1.5,0,2,7,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {7,1,1,0,5,10,8,1,1,20,0,1,1.2,0,2,4,5,150,20,0,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {8,0,1,0,5,8,15,1,0,40,0,1,1.7,0,2,5,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4},
    {9,1,0,0,5,8,10,1,0,20,0,1,1.5,0,2,5,5,150,20,1,1,2.5,3.5,15000,50,1,0.5,0.0007,0.0015,20,0.1,0.3,1.1,0.01,0.05,0.28,2,1,1,1,16,8,0.001,0.5,12,0,0,12,0,0,0.15,4,4}
    };
