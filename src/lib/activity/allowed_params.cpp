...
init_allowed_params() {
    ...
    ALLOWED_PARAMS[35] = AllowedParam(39,    "MPC_Z_VEL_P",          DOG, "",    "MPC Z VEL P",            -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[36] = AllowedParam(40,    "PAFOL_GT_AC_DST",      DOG, "",    "PAFOL GT AC DST",        -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[37] = AllowedParam(41,    "SDLOG_ON_BOOT",        DOG, "",    "SDLOG ON BOOT",          -1, DISPLAY_VALUES_ON_OFF);
    ALLOWED_PARAMS[38] = AllowedParam(42,    "SENS_SON_ON",          DOG, "",    "SENS SON ON",            -1, DISPLAY_VALUES_ON_OFF);
    ALLOWED_PARAMS[39] = AllowedParam(43,    "UBX_ENABLE_SBAS",      DOG, "",    "UBX ENABLE SBAS",        -1, DISPLAY_VALUES_YES_NO);
    ALLOWED_PARAMS[40] = AllowedParam(44,    "UBX_GPS_MAX_CHN",      DOG, "",    "UBX GPS MAX CHN",        -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[41] = AllowedParam(45,    "UBX_GPS_MIN_CHN",      DOG, "",    "UBX GPS MAX CHN",        -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[42] = AllowedParam(46,    "INAV_W_Z_GPS_P",       DOG, "",    "INAV W Z GPS P",         -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[43] = AllowedParam(47,    "INAV_W_Z_BARO",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[44] = AllowedParam(48,    "NAV_CP_FIR_AL",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[45] = AllowedParam(49,    "NAV_CP_FIR_LA",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[46] = AllowedParam(50,    "NAV_CP_FIR_LO",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[47] = AllowedParam(51,    "NAV_CP_LAS_AL",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[48] = AllowedParam(52,    "NAV_CP_LAS_LA",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[49] = AllowedParam(53,    "NAV_CP_LAS_LO",        DOG, "",    "INAV W Z BARO",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[50] = AllowedParam(54,    "BAT_FLAT_LVL",         DOG, "",    "BAT FLAT LVL",           -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[51] = AllowedParam(55,    "MPC_Z_VEL_MAX_U",      DOG, "",    "MPC Z VEL MAX UP",          -1, DISPLAY_VALUES_EMPTY);
    ALLOWED_PARAMS[52] = AllowedParam(56,    "MPC_Z_VEL_MAX_D",      DOG, "",    "MPC Z VEL MAX DOWN",          -1, DISPLAY_VALUES_EMPTY);
